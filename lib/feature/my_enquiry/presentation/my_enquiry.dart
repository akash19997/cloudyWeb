...
import 'cubit/my_enquiry_cubit.dart';
...
class _MyEnquiryState extends State<MyEnquiry> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      bottom: false,
      child: BlocProvider(
        create: (context) => getIt<MyEnquiryCubit>()
          ..myenquirytDetailListDetails(
        ...
        child: Stack(
          children: [
            Scaffold(
              ...
              body: BlocConsumer<MyEnquiryCubit, MyEnquiryState>(
                    ...
                    loaded: (
                      ...
                      if (responseData!.status_code == '200') {
                                                    ...
                                                    children: [
                                                      ...
                                                      Column(
                                                        children: [
                                                          CustomImageView(
                                                            url:
                                                                'https://demos.thewebdemo.net/graywhite-dev/${responseData.result![index]['enquiryImage']}',
                                                            height: 70,
                                                            width: 70,
                                                          ),
                                                        ],
                        ...
                        return const DataNotFoundPage(
                          message:
                              "Please make your first enquiry, No Enquiry avaliable!!",
                        );
                      }
                    },
                    orElse: () => Container(),
